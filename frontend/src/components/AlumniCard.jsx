    ...
    return (
      <div className="backdrop-blur-lg bg-black/40 border border-amber-500/30 text-white rounded-xl overflow-hidden shadow-lg p-6 hover:shadow-amber-500/20 hover:bg-black/50 transition duration-300 transform hover:-translate-y-2 text-center">
        ...
        <div className="flex justify-center space-x-6 mt-4">
          {email && (
            <a href={email} target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-700 transition-colors">
          ...
          {linkedinUrl && (
            <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 transition-colors">
