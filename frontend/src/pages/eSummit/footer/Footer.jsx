...
const Footer = () => {
  ...
  rel="noopener noreferrer"
            href="https://www.instagram.com/ecell_iitpatna?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 flex items-center justify-center">
              <FaInstagram />
            </a>
            ...
            target="_blank"
  rel="noopener noreferrer"
            href="https://www.linkedin.com/school/ecell-iit-patna/posts/?feedView=all" className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center">
              <FaLinkedinIn />
            </a>
