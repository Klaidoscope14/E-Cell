    ...
    return (
      <footer className="relative z-50 bg-gradient-to-br from-gray-900 via-blue-950 to-black text-white px-6 py-6 border-t border-blue-800/30 backdrop-blur-sm overflow-hidden">
        ...
        >
          ...
          >
            <a href="https://www.instagram.com/ecell_iitpatna?igsh=OTJ1MmJlYTlseTN2" target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-3 rounded-full text-blue-300 hover:text-pink-600 transition-colors">
            ...
            <a href="https://www.linkedin.com/school/ecell-iit-patna/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="bg-blue-800/30 p-3 rounded-full text-blue-300 hover:text-blue-600 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
